function chklogin()
{
	...
	*/
	...
	$.post('chklogin.php',{'username':username,'password':password},function (d){
		if(d == '4') {
			...
			var usernameMsg = $.parseJSON(d)
			//判断返回类型
			if(typeof(usernameMsg) == "object"){
				$('#loginmsg').html(usernameMsg[0]);
			}else{
